    ...
    _partsModel(modelsProvider->partsModel())
{
    ...
    //ui->capacitanceValueLineEdit->setValidator(new ParameterValueValidator(_capacitanceParam.unitSymbol(), false, this));
    ...
    ui->voltageRatingLineEdit->setValidator(new ParameterValueValidator(_voltageRatingParam.unitSymbol(), true, this));
