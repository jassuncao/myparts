...
QStringList CurrencyHelper::_mostCommonCurrencies;
QMap<QString,QString> CurrencyHelper::_uniqueCurrencies;
CurrencyHelper::_init CurrencyHelper::_initializer;

CurrencyHelper::_init::_init(){
